...
.watermark-logo { position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); width:40mm; height:40mm; object-fit:contain; opacity:0.1; z-index:-1; }
...
:deep(.watermark-logo) { position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); width:40mm; height:40mm; object-fit:contain; opacity:0.1; z-index:-1; }
</style>
