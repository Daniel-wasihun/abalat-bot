...
class ImportUsersRequest extends FormRequest {
    ...
    public static function rowRules(): array {
        ...
        return [
            ...
            'registration_id' => ['required', 'string', Rule::unique('user_info', 'registration_id')->whereNull('deleted_at'), 'regex:' . $idRegex],
    ...
    public static function rowMessages(): array {
        ...
        return [
            ...
            'registration_id.unique' => BackMessage::get('validation.unique', [':attribute' => $attrLabels['registration_id']]),
